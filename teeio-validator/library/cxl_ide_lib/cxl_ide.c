...
bool cxl_init_dev_port(cxl_ide_test_group_context_t *group_context)
{
  ...
  TEEIO_ASSERT(group_context->common.suite_context->test_category == TEEIO_TEST_CATEGORY_CXL_IDE || group_context->common.suite_context->test_category == TEEIO_TEST_CATEGORY_SOC_CXL);
...
bool cxl_scan_devices(void *test_context)
{
  ...
  TEEIO_ASSERT(context->common.suite_context->test_category == TEEIO_TEST_CATEGORY_CXL_IDE || context->common.suite_context->test_category == TEEIO_TEST_CATEGORY_SOC_CXL);
